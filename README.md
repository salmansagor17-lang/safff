...
- المحتوى: Supabase؛ 3022 سؤال في 20 تصنيفًا نشطًا.
...
تحديث 0.12.0: إضافة 300 ميكاب و250 ديزني مع مستويات المصدر، و272 سؤالًا إضافيًا؛ فصل الرياضيات والعلوم والعملات والقرآن والسيرة وقصص القرآن. جميع التصنيفات توفر 10 أسئلة على الأقل لكل مستوى، وأعداد البنك الكلية غير متساوية. تفاصيل الأعداد في data/content-audit.json.

ملف الميكاب الأصلي لا يتضمن صور المنتجات؛ الاستيراد يستخدم أسماء المنتجات لسؤال تخمين الماركة، وصورة الميكاب المحلية غلاف للتصنيف. شرح الاستيراد وحدود المراجعة في [تقرير التحديث](docs/CONTENT-UPDATE-0.12.0.ar.md).
